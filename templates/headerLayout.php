	...
	<!-- App Styles -->
	<link rel="stylesheet" type="text/css" media="all" href="//<?=$_SERVER['HTTP_HOST']?>/client/note.css">
	<link rel="stylesheet" type="text/css" media="all" href="//<?=$_SERVER['HTTP_HOST']?>/client/sn-design.css">
	<link rel="stylesheet" type="text/css" media="all" href="//<?=$_SERVER['HTTP_HOST']?>/client/ufaeyes.css">
	...
	<script type="text/javascript" src="//<?=$_SERVER['HTTP_HOST']?>/client/ufaeyes.js"></script>
